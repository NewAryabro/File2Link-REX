...
async def gen_link_batch(bot, message: Message):
    if " " not in message.text:
        return await message.reply("Use correct format.\nExample <code>/batch https://t.me/Telugu_Movies_999/15 https://t.me/Telugu_Movies_999/20</code>.")

    links = message.text.strip().split(" ")
    if len(links) != 3:
        return await message.reply("Use correct format.\nExample <code>/batch https://t.me/Telugu_Movies_999/10 https://t.me/Telugu_Movies_999/30</code>.")
